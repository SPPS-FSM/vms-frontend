...
import SidebarDekan from "../../components/dekan/sidebar";
import NavbarDekan from "../../components/dekan/navbar";
import { useNavigate } from "react-router-dom";

export default function AllSuratDekan() {
  ...
  return (
    <div className="bg-gray-100 h-full flex flex-col min-h-screen font-m-plus-rounded">
      ...
      {/* Navbar */}
      <NavbarDekan openSidebar={openSidebar} setOpenSidebar={setOpenSidebar} />
              ...
              <div className="flex flex-col lg:flex-row justify-between mr-0 md:mr-2 pt-2 gap-2 ">
                ...
                <div className="flex justify-start lg:justify-center items-center">
                  <Button
                    ...
                    onClick={()=>navigate("/dekan/edit-surat")}
                  >
