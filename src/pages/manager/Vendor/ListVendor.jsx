...
import { TableVendor } from "../../../components/manager/Vendor/tableVendor";
...
export default function ListVendor() {
  ...
  return (
    <div className="bg-gray-100 h-full flex flex-col min-h-screen font-m-plus-rounded">
      ...
      {/* Navbar */}
      <NavbarManager openSidebar={openSidebar} setOpenSidebar={setOpenSidebar} />
