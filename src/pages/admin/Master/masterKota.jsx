...
import { TableKota } from "../../../components/admin/Master/tableKota";
...
export default function MasterKota() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "http://localhost:4000/api/kota/kota",
        {
          id_kota: Number(formData.id_kota),
      ...
      <div className="md:ml-80 ml-10 mr-8 mt-10 h-full flex-grow bg-grey-100">
        <div className="bg-white px-2 py-2 rounded-md shadow-md">
          <div className="md:flex justify-between items-center">
            <div className="font-semibold mb-4 md:mb-0">Kota</div>
          ...
          <div className="text-sm text-gray-500 my-4">
            <TableKota kota={data} setKota={setData} fetchKota={fetchKota} />
          </div>
        </div>
      </div>
