...
import TableSertifikasiVendor from "../../../components/staff/Kompetensi/tableSertifikasiVendor";

export default function SertifikasiVendor() {
      ...
      <div className="md:ml-80 ml-10 mr-8 mt-10 h-full flex-grow bg-grey-100">
        <div className="bg-white px-2 py-2 rounded-md shadow-md">
          <div className="md:flex justify-between items-center">
            <div className="font-semibold mb-4 md:mb-0">Sertifikasi Vendor</div>
