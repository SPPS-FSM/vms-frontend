...
export default function NavbarPetugasPeralatan({ setOpenSidebar, openSidebar }) {
  ...
  return (
    <div className="bg-fsmblue-500 flex justify-between items-center px-8 h-[80px] shadow-sm gap-4 relative">
      ...
      <div className="flex justify-end items-center shadow-sm gap-4 text-white relative pr-4">
        <div className="font-medium">Selamat Datang, Petugas Peralatan</div>
        {/* Profile */}
