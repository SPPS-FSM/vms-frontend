...
export default function SidebarPetugasPeralatan() {
  ...
  return (
    <div className=" w-full h-screen max-w-[20rem] p-4 shadow-md shadow-blue-gray-900/5">
      ...
      <List className="text-fsmblue-500 font-normal">
        {/* <a href="/Dashboard"> */}
          <Accordion>
            <ListItem onClick={() => navigate("/petugas/dashboard")}>
              <ListItemPrefix>
        ...
        >
          ...
          <AccordionBody className="py-1">
            <List className="p-0">
              {/* <a href="/AllSurat"> */}
                <ListItem className="text-fsmblue-500" onClick={() => navigate("/petugas/semua-surat")}>
