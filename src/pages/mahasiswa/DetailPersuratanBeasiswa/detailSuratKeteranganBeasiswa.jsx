...
export default function DetailSuratKeteranganBeasiswa() {
  ...
  return (
    <div className="relative bg-gray-50">
      ...
      <div className="absolute top-60 md:top-56 lg:top-52 left-1/2 transform -translate-x-1/2 -translate-y-3/4 z-10 text-center">
        <p className="text-5xl text-orange-500 font-bold">Surat Keterangan Beasiswa</p>
      </div>
