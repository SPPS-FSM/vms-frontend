...
export default function AllSuratKasubbag() {
  ...
  const TABLE_ROWS = [
    {
      no: "0901/A.A8/KP/2009",
      type: "Surat Pengajuan Cuti",
      stat: "Menunggu Tandatangan Kasubbag",
      ket: true,
    },
    {
      no: "0902/A.A8/KP/2009",
      type: "Surat Pengajuan Cuti",
      stat: "Menunggu Tandatangan Kasubbag",
      ket: false,
    },
        ...
        <Card className="h-full w-full">
            ...
            <div className="gap-6">
              <div className="grid grid-cols-1 xl:grid-cols-12 gap-1">
                ...
                <div className="mb-1 xl:mb-0 flex items-center justify-start xl:justify-center">
                  <Button size="md" className="bg-light-green-500">
                    Filter
                  </Button>
                </div>
              </div>
          ...
          <CardBody className="overflow-scroll px-0">
            <table className="mt-4 w-full min-w-max table-auto text-left">
              ...
              <tbody>
                {TABLE_ROWS.map(({ no, type, stat, ket }, index) => {
